                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if ($user)
                        ...
                        @elseif(Str::contains($user->email, 'head'))
                            ...
                            <x-nav-link :href="route('academic-head.tasks.index')" :active="request()->routeIs('academic-head.tasks.index')">
                                Manage Tasks
                            </x-nav-link>
                        ...
                        @elseif(Str::contains($user->email, 'staff'))
                            ...
                            <x-nav-link :href="route('academic-staff.tasks.index')" :active="request()->routeIs('academic-staff.tasks.index')">
                                My Tasks
                            </x-nav-link>
        ...
        <div class="pt-2 pb-3 space-y-1">
            @if ($user)
                ...
                @elseif(Str::contains($user->email, 'staff'))
                    ...
                    <x-responsive-nav-link :href="route('academic-staff.tasks.index')" :active="request()->routeIs('academic-staff.tasks.index')">
                        My Tasks
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('academic-staff.groups.index')" :active="request()->routeIs('academic-staff.groups.index')">
                        My Groups
                    </x-responsive-nav-link>
                @endif
            @endif
